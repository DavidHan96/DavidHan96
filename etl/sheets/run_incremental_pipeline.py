...
# -------------------------------------------------------------------
def main():
    print("🚀 Running INCREMENTAL pipeline (Incremental Load + STG + DIM + FACT)")
    
    # Step 1: Incremental load from Google Sheets → RAW
    subprocess.run(["py", "-3.13", "etl/sheets/incremental_load.py"], check=True)
